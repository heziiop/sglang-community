...
class DecodePreallocQueue:
    ...
    def _pre_alloc(
        ...
        if self.scheduler.enable_hisparse:
            ...
            if (
                alloc_need > 0
                and self.scheduler.server_args.disaggregation_enable_decode_radix_cache
            ):
...
class DecodeTransferQueue:
    ...
    def _abort_and_release(self, decode_req: DecodeRequest):
        ...
        if decode_req.req.disagg_decode_prefix_len > 0:
            decode_req.req.cache_protected_len = decode_req.req.disagg_decode_prefix_len
        ...
        if decode_req.req.last_node is None and hasattr(self.tree_cache, "root_node"):
